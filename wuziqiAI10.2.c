...
struct eva_outcome evaluator(int color)
{
	...
	struct evaluation eva_anti = {0, 0, 0, 0, 0, 0, 0, 0};
        ...
        if(i > 0 && i < 237)
            {
                ...
                {
                    if (RecordBoard_heng[i + 1] == color)
                    {
                        if (RecordBoard_heng[i + 2] == color)
                        {
                            if (RecordBoard_heng[i + 3] == color)
                            {
                                if (RecordBoard_heng[i + 4] == color)
                                {
                                    eva.wu++;
                                    i += 4;
                                }
                                else if (RecordBoard_heng[i + 4] == 0 && RecordBoard_heng[i - 1] == 0)
                                {
                                    eva.huo_si++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
                            else if (RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i - 1] == 0)
                            {
                                eva.huo_san++;
                                i += 3;
                            }
                        ...
                        else if (RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == color && RecordBoard_heng[i + 4] == color)
                        {
                            eva.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 4] == 0 && RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == color)
                        {
                            eva.huo_san++;
                            i += 3;
                        }
                        else if (RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i - 1] == 0)
                        {
                            eva.huo_er++;
                            i += 2;
                        }
                    ...
                    else if (RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == color && RecordBoard_heng[i + 3] == color && RecordBoard_heng[i + 4] == color)
                    {
                        eva.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 4] == 0 && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == color && RecordBoard_heng[i + 3] == color)
                    {
                        eva.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == color)
                    {
                        eva.huo_er++;
                        i += 2;
                    }
                    else if (RecordBoard_heng[i + 1] == 0 || RecordBoard_heng[i - 1] == 0)
                    {
                        eva.yi++;
                        i++;
                    }
        ...
        if(i > 0 && i < 237)
            {
                ...
                {
                    if (RecordBoard_shu[i + 1] == color)
                    {
                        if (RecordBoard_shu[i + 2] == color)
                        {
                            if (RecordBoard_shu[i + 3] == color)
                            {
                                if (RecordBoard_shu[i + 4] == color)
                                {
                                    eva.wu++;
                                    i += 4;
                                }
                                else if (RecordBoard_shu[i + 4] == 0 && RecordBoard_shu[i - 1] == 0)
                                {
                                    eva.huo_si++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
                            else if (RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i - 1] == 0)
                            {
                                eva.huo_san++;
                                i += 3;
                            }
                        ...
                        else if (RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == color && RecordBoard_shu[i + 4] == color)
                        {
                            eva.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 4] == 0 && RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == color)
                        {
                            eva.huo_san++;
                            i += 3;
                        }
                        else if (RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i - 1] == 0)
                        {
                            eva.huo_er++;
                            i += 2;
                        }
                    ...
                    else if (RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == color && RecordBoard_shu[i + 3] == color && RecordBoard_shu[i + 4] == color)
                    {
                        eva.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 4] == 0 && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == color && RecordBoard_shu[i + 3] == color)
                    {
                        eva.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == color)
                    {
                        eva.huo_er++;
                        i += 2;
                    }
                    else if (RecordBoard_shu[i + 1] == 0 || RecordBoard_shu[i - 1] == 0)
                    {
                        eva.yi++;
                        i++;
                    }
                 ...
                 if (RecordBoard_shu[i] == color)
                {
                    if (i + 1 <= 240 && RecordBoard_shu[i + 1] == color)
                    {
                        if (i + 2 <= 240 && RecordBoard_shu[i + 2] == color)
                        {
                            ...
                            else if (i + 4 <= 240 && RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
        ...
        if(i > 0 && i < 223)
            {
                ...
                {
                    if (RecordBoard_zuo[i + 1] == color)
                    {
                        if (RecordBoard_zuo[i + 2] == color)
                        {
                            if (RecordBoard_zuo[i + 3] == color)
                            {
                                if (RecordBoard_zuo[i + 4] == color)
                                {
                                    eva.wu++;
                                    i += 4;
                                }
                                else if (RecordBoard_zuo[i + 4] == 0 && RecordBoard_zuo[i - 1] == 0)
                                {
                                    eva.huo_si++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
                            else if (RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i - 1] == 0)
                            {
                                eva.huo_san++;
                                i += 3;
                            }
                        ...
                        else if (RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == color && RecordBoard_zuo[i + 4] == color)
                        {
                            eva.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 4] == 0 && RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == color)
                        {
                            eva.huo_san++;
                            i += 3;
                        }
                        else if (RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i - 1] == 0)
                        {
                            eva.huo_er++;
                            i += 2;
                        }
                    ...
                    else if (RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == color && RecordBoard_zuo[i + 3] == color && RecordBoard_zuo[i + 4] == color)
                    {
                        eva.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 4] == 0 && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == color && RecordBoard_zuo[i + 3] == color)
                    {
                        eva.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == color)
                    {
                        eva.huo_er++;
                        i += 2;
                    }
                    else if (RecordBoard_zuo[i + 1] == 0 || RecordBoard_zuo[i - 1] == 0)
                    {
                        eva.yi++;
                        i++;
                    }
...
for (int i = 0; i <= 226; i++)
        ...
        if(i > 0 && i < 223)
            {
                ...
                {
                    if (RecordBoard_you[i + 1] == color)
                    {
                        if (RecordBoard_you[i + 2] == color)
                        {
                            if (RecordBoard_you[i + 3] == color)
                            {
                                if (RecordBoard_you[i + 4] == color)
                                {
                                    eva.wu++;
                                    i += 4;
                                }
                                else if (RecordBoard_you[i + 4] == 0 && RecordBoard_you[i - 1] == 0)
                                {
                                    eva.huo_si++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
                            else if (RecordBoard_you[i + 3] == 0 && RecordBoard_you[i - 1] == 0)
                            {
                                eva.huo_san++;
                                i += 3;
                            }
                        ...
                        else if (RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == color && RecordBoard_you[i + 4] == color)
                        {
                            eva.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 4] == 0 && RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == color)
                        {
                            eva.huo_san++;
                            i += 3;
                        }
                        else if (RecordBoard_you[i + 2] == 0 && RecordBoard_you[i - 1] == 0)
                        {
                            eva.huo_er++;
                            i += 2;
                        }
                    ...
                    else if (RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == color && RecordBoard_you[i + 3] == color && RecordBoard_you[i + 4] == color)
                    {
                        eva.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 4] == 0 && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == color && RecordBoard_you[i + 3] == color)
                    {
                        eva.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == color)
                    {
                        eva.huo_er++;
                        i += 2;
                    }
                    else if (RecordBoard_you[i + 1] == 0 || RecordBoard_you[i - 1] == 0)
                    {
                        eva.yi++;
                        i++;
                    }
                 ...
                 if (RecordBoard_you[i] == color)
                {
                    if (i + 1 <= 226 && RecordBoard_you[i + 1] == color)
                    {
                        if (i + 2 <= 226 && RecordBoard_you[i + 2] == color)
                        {
                            ...
                            else if (i + 4 <= 226 && RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 4] == color)
                            {
                                eva.si_si++;
                                i += 4;
                            }
		...
		for (int i = 0; i <= 240; i++)
	{
        if(i > 0 && i < 237)
            {
                if (RecordBoard_heng[i] == anti_color)
                {
                    if (RecordBoard_heng[i + 1] == anti_color)
                    {
                        if (RecordBoard_heng[i + 2] == anti_color)
                        {
                            if (RecordBoard_heng[i + 3] == anti_color)
                            {
                                if (RecordBoard_heng[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == anti_color && RecordBoard_heng[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 4] == 0 && RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color && RecordBoard_heng[i + 3] == anti_color && RecordBoard_heng[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 4] == 0 && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color && RecordBoard_heng[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_heng[i - 1] == 0 && RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
        ...
        else
            {
                 if (RecordBoard_heng[i] == anti_color)
                {
                    if (i + 1 <= 240 && RecordBoard_heng[i + 1] == anti_color)
                    {
                        if (i + 2 <= 240 && RecordBoard_heng[i + 2] == anti_color)
                        {
                            if (i + 3 <= 240 && RecordBoard_heng[i + 3] == anti_color)
                            {
                                if (i + 4 <= 240 && RecordBoard_heng[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (i + 4 <= 240 && RecordBoard_heng[i + 3] == 0 && RecordBoard_heng[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (i + 4 <= 240 && RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == anti_color && RecordBoard_heng[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if ((i - 1 >= 0 && RecordBoard_heng[i - 1] == 0) && (i + 4 <= 240 && RecordBoard_heng[i + 4] == 0) && RecordBoard_heng[i + 2] == 0 && RecordBoard_heng[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (i + 4 <= 240 && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color && RecordBoard_heng[i + 3] == anti_color && RecordBoard_heng[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if ((i - 1 >= 0 && RecordBoard_heng[i - 1] == 0) && (i + 4 <= 240 && RecordBoard_heng[i + 4] == 0) && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color && RecordBoard_heng[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if ((i - 1 >= 0 && RecordBoard_heng[i - 1] == 0) && (i + 3 <= 240 && RecordBoard_heng[i + 3] == 0) && RecordBoard_heng[i + 1] == 0 && RecordBoard_heng[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
...
for (int i = 0; i <= 240; i++)
	{
        if(i > 0 && i < 237)
            {
                if (RecordBoard_shu[i] == anti_color)
                {
                    if (RecordBoard_shu[i + 1] == anti_color)
                    {
                        if (RecordBoard_shu[i + 2] == anti_color)
                        {
                            if (RecordBoard_shu[i + 3] == anti_color)
                            {
                                if (RecordBoard_shu[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == anti_color && RecordBoard_shu[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 4] == 0 && RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color && RecordBoard_shu[i + 3] == anti_color && RecordBoard_shu[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 4] == 0 && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color && RecordBoard_shu[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_shu[i - 1] == 0 && RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
        ...
        else
            {
                 if (RecordBoard_shu[i] == anti_color)
                {
                    if (i + 1 <= 240 && RecordBoard_shu[i + 1] == anti_color)
                    {
                        if (i + 2 <= 240 && RecordBoard_shu[i + 2] == anti_color)
                        {
                            if (i + 3 <= 240 && RecordBoard_shu[i + 3] == anti_color)
                            {
                                if (i + 4 <= 240 && RecordBoard_shu[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (i + 4 <= 240 && RecordBoard_shu[i + 3] == 0 && RecordBoard_shu[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (i + 4 <= 240 && RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == anti_color && RecordBoard_shu[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if ((i - 1 >= 0 && RecordBoard_shu[i - 1] == 0) && (i + 4 <= 240 && RecordBoard_shu[i + 4] == 0) && RecordBoard_shu[i + 2] == 0 && RecordBoard_shu[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (i + 4 <= 240 && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color && RecordBoard_shu[i + 3] == anti_color && RecordBoard_shu[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if ((i - 1 >= 0 && RecordBoard_shu[i - 1] == 0) && (i + 4 <= 240 && RecordBoard_shu[i + 4] == 0) && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color && RecordBoard_shu[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if ((i - 1 >= 0 && RecordBoard_shu[i - 1] == 0) && (i + 3 <= 240 && RecordBoard_shu[i + 3] == 0) && RecordBoard_shu[i + 1] == 0 && RecordBoard_shu[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
...
for (int i = 0; i <= 226; i++)
	{
        if(i > 0 && i < 223)
            {
                if (RecordBoard_zuo[i] == anti_color)
                {
                    if (RecordBoard_zuo[i + 1] == anti_color)
                    {
                        if (RecordBoard_zuo[i + 2] == anti_color)
                        {
                            if (RecordBoard_zuo[i + 3] == anti_color)
                            {
                                if (RecordBoard_zuo[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == anti_color && RecordBoard_zuo[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 4] == 0 && RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color && RecordBoard_zuo[i + 3] == anti_color && RecordBoard_zuo[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 4] == 0 && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color && RecordBoard_zuo[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_zuo[i - 1] == 0 && RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
        ...
        else
            {
                 if (RecordBoard_zuo[i] == anti_color)
                {
                    if (i + 1 <= 226 && RecordBoard_zuo[i + 1] == anti_color)
                    {
                        if (i + 2 <= 226 && RecordBoard_zuo[i + 2] == anti_color)
                        {
                            if (i + 3 <= 226 && RecordBoard_zuo[i + 3] == anti_color)
                            {
                                if (i + 4 <= 226 && RecordBoard_zuo[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (i + 4 <= 226 && RecordBoard_zuo[i + 3] == 0 && RecordBoard_zuo[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (i + 4 <= 226 && RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == anti_color && RecordBoard_zuo[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if ((i - 1 >= 0 && RecordBoard_zuo[i - 1] == 0) && (i + 4 <= 226 && RecordBoard_zuo[i + 4] == 0) && RecordBoard_zuo[i + 2] == 0 && RecordBoard_zuo[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (i + 4 <= 226 && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color && RecordBoard_zuo[i + 3] == anti_color && RecordBoard_zuo[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if ((i - 1 >= 0 && RecordBoard_zuo[i - 1] == 0) && (i + 4 <= 226 && RecordBoard_zuo[i + 4] == 0) && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color && RecordBoard_zuo[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if ((i - 1 >= 0 && RecordBoard_zuo[i - 1] == 0) && (i + 3 <= 226 && RecordBoard_zuo[i + 3] == 0) && RecordBoard_zuo[i + 1] == 0 && RecordBoard_zuo[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
...
for (int i = 0; i <= 226; i++)
	{
        if(i > 0 && i < 223)
            {
                if (RecordBoard_you[i] == anti_color)
                {
                    if (RecordBoard_you[i + 1] == anti_color)
                    {
                        if (RecordBoard_you[i + 2] == anti_color)
                        {
                            if (RecordBoard_you[i + 3] == anti_color)
                            {
                                if (RecordBoard_you[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == anti_color && RecordBoard_you[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 4] == 0 && RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color && RecordBoard_you[i + 3] == anti_color && RecordBoard_you[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 4] == 0 && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color && RecordBoard_you[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if (RecordBoard_you[i - 1] == 0 && RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
        ...
        else
            {
                 if (RecordBoard_you[i] == anti_color)
                {
                    if (i + 1 <= 226 && RecordBoard_you[i + 1] == anti_color)
                    {
                        if (i + 2 <= 226 && RecordBoard_you[i + 2] == anti_color)
                        {
                            if (i + 3 <= 226 && RecordBoard_you[i + 3] == anti_color)
                            {
                                if (i + 4 <= 226 && RecordBoard_you[i + 4] == anti_color)
                                {
                                    eva_anti.wu++;
                                    i += 4;
                                }
                            ...
                            else if (i + 4 <= 226 && RecordBoard_you[i + 3] == 0 && RecordBoard_you[i + 4] == anti_color)
                            {
                                eva_anti.si_si++;
                                i += 4;
                            }
                        ...
                        else if (i + 4 <= 226 && RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == anti_color && RecordBoard_you[i + 4] == anti_color)
                        {
                            eva_anti.si_si++;
                            i += 4;
                        }
                        else if ((i - 1 >= 0 && RecordBoard_you[i - 1] == 0) && (i + 4 <= 226 && RecordBoard_you[i + 4] == 0) && RecordBoard_you[i + 2] == 0 && RecordBoard_you[i + 3] == anti_color)
                        {
                            eva_anti.huo_san++;
                            i += 3;
                        }
                    ...
                    else if (i + 4 <= 226 && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color && RecordBoard_you[i + 3] == anti_color && RecordBoard_you[i + 4] == anti_color)
                    {
                        eva_anti.si_si++;
                        i += 4;
                    }

                    else if ((i - 1 >= 0 && RecordBoard_you[i - 1] == 0) && (i + 4 <= 226 && RecordBoard_you[i + 4] == 0) && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color && RecordBoard_you[i + 3] == anti_color)
                    {
                        eva_anti.huo_san++;
                        i += 3;
                    }
                    else if ((i - 1 >= 0 && RecordBoard_you[i - 1] == 0) && (i + 3 <= 226 && RecordBoard_you[i + 3] == 0) && RecordBoard_you[i + 1] == 0 && RecordBoard_you[i + 2] == anti_color)
                    {
                        eva_anti.huo_er++;
                        i += 2;
                    }
	...
	outcomes.outcome_anti = (eva_anti.yi * yi_eva_anti) + (eva_anti.si_er * si_er_eva_anti) + (eva_anti.huo_er * huo_er_eva_anti) + (eva_anti.si_san * si_san_eva_anti) + (eva_anti.huo_san * huo_san_eva_anti) + (eva_anti.si_si * si_si_eva_anti) + (eva_anti.huo_si * huo_si_eva_anti) + (eva_anti.wu * wu_eva_anti);
	outcomes.huo_san_anti = eva_anti.huo_san;
	outcomes.huo_si_anti = eva_anti.huo_si;
	outcomes.si_si_anti = eva_anti.si_si;
	outcomes.wu_anti = eva_anti.wu;

	outcomes.outcome = (eva.yi * yi_eva) + (eva.si_er * si_er_eva) + (eva.huo_er * huo_er_eva) + (eva.si_san * si_san_eva) + (eva.huo_san * huo_san_eva) + (eva.si_si * si_si_eva) + (eva.huo_si * huo_si_eva) + (eva.wu * wu_eva);
...
struct results outcomer(int color)
{
	...
	int anti_color = (color - 1) ? 1 : 2;
	struct eva_outcome outcome = evaluator(color);
	result.result = outcome.outcome - outcome.outcome_anti;
	if (outcome.wu >= 1)
		result.kill = color;
	else if (outcome.huo_si >= 1 && (outcome.huo_si_anti == 0 && outcome.si_si_anti == 0 && outcome.wu_anti == 0))
		result.kill = color;
	else if (outcome.si_si >= 2 && (outcome.huo_si_anti == 0 && outcome.si_si_anti == 0 && outcome.wu_anti == 0))
		result.kill = color;
	else if (outcome.huo_san >= 2 && (outcome.huo_si_anti == 0 && outcome.si_si_anti == 0 && outcome.wu_anti == 0 && outcome.huo_san_anti == 0))
		result.kill = color;

	if (outcome.wu_anti >= 1)
		result.kill = anti_color;
	else if (outcome.huo_si_anti >= 1 && (outcome.huo_si == 0 && outcome.si_si == 0 && outcome.wu == 0))
		result.kill = anti_color;
	else if (outcome.si_si_anti >= 2 && (outcome.huo_si == 0 && outcome.si_si == 0 && outcome.wu == 0))
		result.kill = anti_color;
	else if (outcome.huo_san_anti >= 2 && (outcome.huo_si == 0 && outcome.si_si == 0 && outcome.wu == 0 && outcome.huo_san == 0))
		result.kill = anti_color;
		...
		if (depth <= depth_max)
		{
			...
			for (i = 0; i <= width; i++)
			{
				...
				if (val.kill == initialAIcolor)
				{
					...
					if (depth == 0)
					{
						if(aRecordBoard[(*index[i]).x][(*index[i]).y] == 0)
						{
							choose[0] = (*index[i]).x;
							choose[1] = (*index[i]).y;
						}
				...
				else if (val.kill == initialplayercolor)
				{
					alpha = -100000;
					if (depth != 0)
						break;
	...
	else if (player == initialplayercolor)
	{
		...
		if (depth <= depth_max)
		{
			...
			for (i = 0; i <= width; i++)
			{
				...
				else if (val.kill == initialAIcolor)
				{
					beta = 100000;
					break;
				}
...
//		kaiju();
	...
	if (aRecordBoard[choose[0]][choose[1]] == 0)
	{
		...
		if(initialAIcolor == 2)
		{
			aDisplayBoardArray[choose[0]][2 * choose[1]] = play2CurrentPic[0];
			aDisplayBoardArray[choose[0]][2 * choose[1] + 1] = play2CurrentPic[1];
		}
		else
		{
			aDisplayBoardArray[choose[0]][2 * choose[1]] = play1CurrentPic[0];
			aDisplayBoardArray[choose[0]][2 * choose[1] + 1] = play1CurrentPic[1];
		}
		return 2;
	}
	else
